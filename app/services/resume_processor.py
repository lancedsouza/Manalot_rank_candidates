...
# # SCORING CONFIG
# # ============================================================
# # Similarity above which a JD skill is considered "covered"
# COVERAGE_THRESHOLD = 0.75

# # Hybrid weights: how much each component contributes to the final score
# W_PARENT   = 0.20   # holistic resume ↔ JD embedding similarity
# W_COVERAGE = 0.55   # % of JD skills that are matched
...
#     # ---- Skill: coverage (% JD skills matched) + depth (avg sim of matches) ----
#     skill_sql = text("""
#         WITH best AS (
#             SELECT
...
#     # Skill score blends coverage with quality of the matched pairs
#     skill_sim = 0.5 * coverage + 0.5 * avg_matched_depth

#     # Final hybrid — coverage dominates
#     hybrid = (
#         W_PARENT   * parent_sim
#       + W_COVERAGE * coverage
